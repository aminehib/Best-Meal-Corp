            ...
            <div class="admin-form-box">
                <form action="//projet-recette/actions/ajouter.php" method="POST" enctype="multipart/form-data" class="admin-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="preparation_time" name="preparation_time" placeholder="Ex : 20" min="1">
                    </div>

                    <div class="form-group">
                        <label for="cooking_time">Temps de cuisson</label>
                        <input type="number" id="cooking_time" name="cooking_time" placeholder="Ex : 25" min="1">
                    </div>

                    <div class="form-group">
                        <label for="servings">Nombre de personnes</label>
                        <input type="number" id="servings" name="servings" placeholder="Ex : 4" min="1">
                    </div>
